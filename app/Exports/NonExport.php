...
class NonExport implements FromView, WithColumnWidths
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('admin.non.export', ['members' => $members, 'from_date'=>$this->from_date, 'to_date'=>$this->to_date, 'option'=>$this->option]);
    }
