...
@section('title_bar', 'Residential Package')
@section('breadcrumb', 'Residential Package')
@section('maincontent')
                ...
                <div class="col-xl-12">
                    <div class="card" id="accordion-one">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center px-3">
                              <h4 class="card-title mb-0">Residential Package</h4>
...
<script>
     $(document).on("click","#export-btn",function() {
        $('#search').attr("action", "{{ url('admin/resident-package/export') }}");
        $('#search').submit();
    });
