...
@section('title_bar', 'Internarional Members Detail')
@section('breadcrumb', 'Internarional')
@section('maincontent')
<style>
                            ...
                            @foreach($additional_package as $package)
                                ...
                                @if(isset($package->room_tarrif_price) && !empty($package->room_tarrif_price) && $package->room_tarrif_price != 0.00)
                                    ...
                                    <p class="text-primary">{{ 
                                        isset($package->room_tarrif) && !empty($package->room_tarrif)
                                            ? ($package->room_tarrif == 'single_bed'
                                                ? 'Single Bed'
                                                : ($package->room_tarrif == 'double_bed'
                                                    ? 'Double Bed'
                                                    : ucfirst($package->room_tarrif)))
                                            : '' 
                                    }}
                                    </p>
