...
@section('title_bar', 'Airs Members Detail')
@section('breadcrumb', 'Airs Members Detail')
@section('maincontent')
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-6 mb-3">
                                <ul class="student-details">
                                    ...
                                    <li>
                                        <span>Phone:</span>
                                        <h5 class="mb-0">+91 {{ ucfirst($member->mobile) }}</h5>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <p>
                                        ...
                                        {{isset($r_date) && !empty($r_date) ? date("d M, Y", strtotime($r_date)) : '' }} - 
                                        @endforeach
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <p>{{isset($member->name) && !empty($member->name) ? $member->name : '' }}<br/>{{isset($member->mobile) && !empty($member->mobile) ? $member->mobile : '' }}</p>
                                </div>
                            </div>
                            <div class="col-xl-6 col-sm-6">
                                <div class="mb-3">
