...
<div class="container">
	...
	<div class="font">
     ...
     <!--       @if(isset($pack->gala_dinner_price) && !empty($pack->gala_dinner_price) && $pack->gala_dinner_price != 0.00 -->
     <!--           && isset($pack->room_tarrif_price) && !empty($pack->room_tarrif_price) && $pack->room_tarrif_price != 0.00)-->
                
     <!--           <img src="{{ public_path('Untitled-1.jpg') }}" style="width:40px;position:relative;left:5px;" />-->
     <!--           <img src="{{ public_path('Untitled-2.jpg') }}" style="width:40px;position:relative;top:45px;left:-40px;" />-->
        
     <!--       @elseif(isset($pack->gala_dinner_price) && !empty($pack->gala_dinner_price) && $pack->gala_dinner_price != 0.00)-->
                
     <!--           <img src="{{ public_path('Untitled-1.jpg') }}" style="width:40px;position:relative;top:10px;left:10px;" />-->
        
     <!--       @elseif(isset($pack->room_tarrif_price) && !empty($pack->room_tarrif_price) && $pack->room_tarrif_price != 0.00)-->
