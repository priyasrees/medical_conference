<div class="nav-header">
    <a href="{{ url('admin/dashboard') }}" class="brand-logo">
        <div class="logo-img">
            <img src="{{ env('APP_URL').'public/admin_asset/images/logo.png' }}">
        </div>
    </a>
    <div class="nav-control">
        <div class="hamburger">
            ...
            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22" y="11" width="4" height="4" rx="2" fill="#000" />
                <rect x="11" width="4" height="4" rx="2" fill="#000" />
                <rect x="22" width="4" height="4" rx="2" fill="#000" />
                <rect x="11" y="11" width="4" height="4" rx="2" fill="#000" />
                <rect x="11" y="22" width="4" height="4" rx="2" fill="#000" />
                <rect width="4" height="4" rx="2" fill="#000" />
                <rect y="11" width="4" height="4" rx="2" fill="#000" />
                <rect x="22" y="22" width="4" height="4" rx="2" fill="#000" />
                <rect y="22" width="4" height="4" rx="2" fill="#000" />
            </svg>
        </div>
    </div>
</div>
        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown search-area-header" style="visibility: hidden;">
                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button"
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="{{ env('APP_URL').'public/admin_asset/images/logo.png' }}" style="width:auto" alt="">
                                </div>
                            </a>
                                ...
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <img src="{{ env('APP_URL').'public/admin_asset/images/logo.png' }}" style="width:auto" class="ms-0" alt="">
                                            </li>
                                            <li class="ms-2">
